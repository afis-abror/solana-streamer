...
async fn main() -> anyhow::Result<()> {
    ...
    use solana_streamer_sdk::streaming::common::{StreamClientConfig, AutoReconnectConfig, ConnectionConfig};
    ...
    let _client2 = ShrederClient::new_with_config_and_local_addr(endpoint2, config, Some(local_ip2)).await?;
